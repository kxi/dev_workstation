...
# Install Eclipse
sudo tar -zxvf /vagrant/files/eclipse-jee-mars-1-linux-gtk-x86_64.tar.gz -C /opt/
cp /vagrant/files/eclipse.desktop /usr/share/applications/
...
cp /vagrant/files/smartgit-generic-${Smartgit_VERSION}.tar.gz /tmp/
